...
#################################################################
#
#  Use for HW 3: load pre-cached Datasets to save a lot of time
#

def load_precached_folds(args:argparse.ArgumentParser, seed:int=42):
    '''
    ...
    The raw Core 50 data set has:
    - 10 object classes
    - 5 object instances per class
    - 11 background conditions in which each of the object instances are imaged in

    These examples have already been combined into a set of N folds.  For HW3:
    - A total of 4 object classes
    - Each fold has one instance of each object class and all conditions
    ...
    nobjects = df['nclasses'].values[0]
    nfolds = df['nfolds'].values[0]
